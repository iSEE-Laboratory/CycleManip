...
class DPRunner:
    ...
    def get_action(self, policy: BaseImagePolicy, observaton=None):
        ...
        # device transfer
        np_obs_dict = {k: v for k, v in obs.items() if "instruction" not in k}
        ...
        with torch.no_grad():
            ...
            obs_dict_input["instruction_int"] = obs["instruction_int"] if "instruction_int" in obs else obs["instruction_sim"]
