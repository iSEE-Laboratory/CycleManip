...
class PaligemmaTokenizer:
    ...
    def __init__(self, max_len: int = 48):
        ...
        # 用这个文件的filepath来定位paligemma_tokenizer.model，防止由于机器切换导致下载的文件路径不一致

        # path = Path("/home/scc/cuixj/workspace2/code/LoopBreaker/policy/pi0/paligemma_tokenizer.model")
        tokenizer_path = os.path.join(os.path.dirname(__file__), "paligemma_tokenizer.model")
