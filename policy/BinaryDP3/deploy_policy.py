...
# 使用DP3的代码路径
dp3_policy_path = os.path.join(parent_directory, '..', 'DP3', '3D-Diffusion-Policy')
sys.path.append(dp3_policy_path)
...
def get_model(usr_args):
    # 使用DP3的配置路径 - 需要使用相对路径
    config_path = "../DP3/3D-Diffusion-Policy/diffusion_policy_3d/config"
...
def eval(TASK_ENV, model, observation):
    ...
    obs = encode_obs(observation)  # Post-Process Observation 也只有一帧
